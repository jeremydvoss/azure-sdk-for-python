...
"""
An example to show an application using Opentelemetry logging sdk to create an Application Insights Event. Logging calls to the standard Python
logging library are tracked and telemetry is exported to application insights with the AzureMonitorLogExporter.
Setting the APPLICATION_INSIGHTS_EVENT_MARKER_ATTRIBUTE log record attribute will cause the exporter to export the log record as an Application Insights Event instead of a Application Insights Trace.
"""
import os
import logging
